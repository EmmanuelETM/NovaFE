 ...
 * municipio, teléfonos, ambiente por defecto) — antes solo lo podía cargar un
 * operador desde `/nemus/tenants/{id}`. Mismo form que
 * `features/tenants/emitter-profile-tab.tsx` (self-scoped, sin `tenantId`).
 */
      ...
      <CardContent>
        {notConfigured && (
          <p className="text-muted-foreground mb-4 text-sm">
            Todavía no tenés un perfil de emisor. Completalo para poder acuñar
            tu primera API key.
          </p>
        )}
