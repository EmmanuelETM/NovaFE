...
/// <summary>
/// Catálogo de tipos de evento de webhook. Formato <c>categoria.evento</c>. v1
/// cubre solo el ciclo de vida del e-CF; los de certificado / secuencia / M5 /
/// M8 / M11 llegan con su módulo (ver <c>docs/webhooks.md</c>).
/// </summary>
public static class WebhookEventType
{
    ...
    private static readonly IReadOnlyList<string> Categories = ["ecf"];
