...
using NovaFE.Infrastructure.Finance.Sql;
...
public static class InfrastructureService
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IFinanceReadRepository, FinanceReadRepository>();
        services.AddScoped<IEcfSubmissionQueue, PostgresEcfSubmissionQueue>();
        services.AddScoped<IOpsStatusReadRepository, OpsStatusReadRepository>();
